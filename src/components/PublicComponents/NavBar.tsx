        ...
        <header className="sticky top-0 z-50 bg-[#0e0e0e]/95 backdrop-blur-md border-b border-white/5">
            <nav className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between gap-6">
                ...
                <div className="hidden md:flex! items-center gap-2 shrink-0">
                    ...
                    {cookies.name ? (
                        <div className="text-sm text-white bg-white/10 px-3 py-1.5 rounded-lg">
                            {cookies.name}
                        </div>
                    ) : (
                        <>
            ...
            {isMobileMenuOpen && (
                <div
                    className="md:hidden border-t border-white/5 bg-[#0e0e0e] p-2 space-y-1 absolute w-full shadow-2xl">
                    ...
                    <div className="flex flex-col space-y-3">
                        ...
                        {cookies.name ? (
                            <div className="text-center text-white bg-white/10 py-3 rounded-xl">
                                {cookies.name}
                            </div>
                        ) : (
                            <>
